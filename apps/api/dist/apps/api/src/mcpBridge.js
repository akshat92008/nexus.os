 ...
 */
// ── Export Builders ────────────────────────────────────────────────────────
function buildMarkdown(sessionId, goal, artifacts) {
...
function buildJSON(sessionId, goal, artifacts) {
...
function buildExcelCSV(artifacts) {
...
function buildPDFHtml(sessionId, goal, artifacts) {
...
export class MCPBridge {
     ...
     */
    deposit(agentId, artifact, sseRes, isAborted = () => false) {
        this.store.set(agentId, artifact);
        console.log(`[MCP] 📦 Deposited — agent: ${agentId} (${artifact.agentType}) ` +
     ...
     */
    announceHandoff(toAgentId, sseRes, isAborted = () => false) {
