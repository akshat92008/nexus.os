 ...
 */
export function parseDeveloperIntent(input) {
    const lower = input.toLowerCase();
    // 1. Determine Intent Type
    let type = 'build_feature';
