...
export interface APLineVariance {
  lineId: string;
  description: string;
...
export interface APResolutionBriefing {
  workflowId: string;
  ...
  discrepancyKind: 'overcharge' | 'undercharge' | 'terms_mismatch';
  rootCause: string;
  recommendedAction: string;
  confidence: 'high' | 'medium' | 'low';
  lineVariances: APLineVariance[];
  draftEmail: ApprovalEmailDraft;
  proposedErpUpdate?: string;
}
