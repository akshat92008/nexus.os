...
export type NexusSSEEvent = ConnectedEvent | PlanReadyEvent | WaveStartEvent | WaveCompleteEvent | RetryWaveEvent | SynthesisStartEvent | AgentSpawnEvent | AgentWorkingEvent | ArtifactDepositedEvent | HandoffEvent | LedgerUpdateEvent | DoneEvent | ErrorEvent | SystemPauseEvent | AwaitingApprovalEvent | SandboxStdoutEvent | SandboxStderrEvent | SandboxStartedEvent | SandboxFinishedEvent;
